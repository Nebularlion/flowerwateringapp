...
class HomeScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = { plants:[...this.state.plants, {key: this.props.navigation.state.params.np}], newPlant: '' };
  }
...
class AddPlantScreen extends React.Component {
  ...
  constructor(props) {
    super(props);
    this.state = { plant: '', text: '', plants: [], name: '',  water: '', humidity: '', winterHumidity: '', light: '', homeRegion: ''};
  }
  ...
  buttonPressed= () =>{
    ...
    navigate('HomeScreen', { np: this.state.plant })
