  ...
  render() {
    return (
        <View style={{
          alignItems: 'center',
          paddingTop: 50}}>
            <Text style={{fontFamily: 'Georgia', fontSize: 20, color: '#007A12',  fontWeight: "bold", paddingBottom: 20, paddingTop: 20}}>Name</Text>
            <TextInput  
              style={{
              borderWidth: 2,
              width: 300,
            ...
            <Text style={{fontFamily: 'Georgia', fontSize: 20, color: '#007A12',  fontWeight: "bold", paddingBottom: 20, paddingTop: 20}}>Water</Text>
            <TextInput  
              style={{
              borderWidth: 2,
              width: 300,
            ...
            <Text style={{fontFamily: 'Georgia', fontSize: 20, color: '#007A12',  fontWeight: "bold", paddingBottom: 20, paddingTop: 20}}>Humidity</Text>
            <TextInput  
              style={{
              borderWidth: 2,
              width: 300,
            ...
            <Text style={{fontFamily: 'Georgia', fontSize: 20, color: '#007A12',  fontWeight: "bold", paddingBottom: 20, paddingTop: 20}}>Winter Humidity</Text>
            <TextInput  
              style={{
              borderWidth: 2,
              width: 300,
            ...
            <Text style={{fontFamily: 'Georgia', fontSize: 20, color: '#007A12',  fontWeight: "bold", paddingBottom: 20, paddingTop: 20}}>Light</Text>
            <TextInput  
              style={{
              borderWidth: 2,
              width: 300,
